...
class Category extends Component {
    ...
    render() {
        ...
        return (
            <AppContainer pageName={'Main Categories'} navigation={this.props.navigation} header={true} >
                <ScrollView style={{ flex: 1, paddingBottom: 50 }} showsVerticalScrollIndicator={false}>
                    <View style={{ flex: 1, alignItems: "center", backgroundColor: '#f6f7f9' }}>
                        ...
                        {categories.map((key, index) => {
                            return (
                                <TouchableOpacity activeOpacity={0.5} onPress={() => { this.props.navigation.navigate('SubCategories') }}>
                                    <View style={{
